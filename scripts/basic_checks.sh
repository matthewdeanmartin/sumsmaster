...
echo "=== sumsmaster basic_checks ==="
echo ""
echo "using: ${CLI_PYTHON} -m sumsmaster"
echo ""

echo "--- global flags ---"
check "sumsmaster --help"    run_cli --help
check "sumsmaster --version" run_cli --version

# TODO: add subcommand smoke checks here, e.g.:
# check "sumsmaster <subcommand> --help"  run_cli <subcommand> --help
